        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card border-0 shadow rounded">
                    <div class="card-body">
                        <a href="{{ route('admin.create') }}" class="btn btn-md btn-success mb-3">TAMBAH BLOG</a>
                              ...
                              @forelse ($admins as $admin)
                                <tr>
                                    <td class="text-center">
                                        <img src="{{ Storage::url('public/admins/').$admin->image }}" class="rounded" style="width: 150px">
                                    </td>
                                    <td>{{ $admin->title }}</td>
                                    <td>{!! $admin->content !!}</td>
                                    <td class="text-center">
